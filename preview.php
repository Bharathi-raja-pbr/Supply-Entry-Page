...
<body>
    ...
    $sql = "SELECT `igp-no`, `igp-dt`, `igp-act-dt`, `igp-tim`, `ref-docno`, `ref-docdt`, `ref-sec`, `igp-stat`, `migp-no` FROM `igp-hd1` where `igp-no`=$lastIgpNo";
    $result = $conn->query($sql);
    ...
    $sql = "SELECT `igp-no`, `dc-rec-no`, `dc-rec-dt`, `igp-itmcd`, `vend-nam`, `igp-au`, `igp-itmqty`, `rb-no`, `igp-itmstat`, `send-epcd`, `send-epdes`, `migp-no`, `migp-sl` FROM `igp-itm1` where `igp-no`=$lastIgpNo";
    $result = $conn->query($sql);
    ...
    $sql = "SELECT `igp-no`, `pkg-mod`, `no-of-pkg`, `pkg-slno` FROM `igp-pkg1` where `igp-no`=$lastIgpNo";
    $result = $conn->query($sql);
    ...
    $sql = "SELECT `igp-no`, `escrt-id`, `escrt-nam`, `escrt-desg` FROM `ig-escrt1` where `igp-no`=$lastIgpNo";
    $result = $conn->query($sql);
    ...
    $sql = "SELECT `igp-no`, `veh-no`, `lr-no`, `lr-dt` FROM `ig-veh1`where `igp-no`=$lastIgpNo";
    $result = $conn->query($sql);
    ...
    $sql = "SELECT `igp-no`, `cd`, `avl` FROM `igp-hd-document1` where `igp-no`=$lastIgpNo";
    $result = $conn->query($sql);
    ...
    <br>
        ...
        <button class="custom-button1" type="button" onclick="window.location.href='documents.php'">Previous</button>
        <button class="custom-button" type="reset" value="Reset">Clear</button>
        <button class="custom-button" type="submit" onclick="window.location.href='submit.php'">Next</button>
</body>
</html>
